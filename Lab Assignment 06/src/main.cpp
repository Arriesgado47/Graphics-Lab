...
// function to generate line points using Bresenham Line Drawing Algorithm
std::vector<float> DDA(float x0, float y0, float x1, float y1)
{
    std::vector<float> points;

    // Convert normalized coordinates to integer grid
...
int main()
{
    ...
    // line endpoints (normalized device coordinates)
    float x0 = -0.5f;
    float y0 = -0.5f;
    float x1 = 0.5f;
    float y1 = 0.5f;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Change color when ESC is pressed
